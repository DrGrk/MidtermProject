...
- (IBAction)didTapScan:(id)sender {
    ...
    float buttonX = scanningViewController.view.frame.size.width / 2;
    float buttonY = scanningViewController.view.frame.size.height - 10;
    
    UIButton *photoButton = [[UIButton alloc]initWithFrame:CGRectMake(buttonX, buttonY, 50, 50)];
    photoButton.backgroundColor = [UIColor blackColor];
    photoButton.layer.cornerRadius = 2;
    photoButton.layer.borderWidth = 1;
    [scanningViewController.view addSubview:photoButton];
